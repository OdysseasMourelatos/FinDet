...
public class Menu {
    ...
    public static void printSubMenuOfChoice2() {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Συνολικά Έσοδα");
        System.out.println(BLUE + "[2] " + RESET + "Συνολικά Έξοδα");

        
        System.out.println(BLUE + "[3] " + RESET + "Βασικές Κατηγορίες Εσόδων (2ψήφιοι)");
        System.out.println(BLUE + "[4] " + RESET + "Βασικές Κατηγορίες Εξόδων (2ψήφιοι)");
        System.out.println(BLUE + "[5] " + RESET + "Βασικές Κατηγορίες Εσόδων & Εξόδων + Αποτέλεσμα Κρατικού Προϋπολογισμού");

        System.out.println(BLUE + "[6] " + RESET + "Προβολή ανά Υπουργείο");
        System.out.println(BLUE + "[7] " + RESET + "Προβολή βάσει Κωδικού (2–10 ψηφία)");

        System.out.println(BLUE + "[8] " +RESET + "Προβολή ΠΔΕ συνολικά");
        System.out.println(BLUE + "[9] " +RESET + "Προβολή ΠΔΕ ανά Σκέλος (Εθνικό / Συγχρ.)");

        System.out.println(BLUE + "[10] " + RESET + "Προβολή ανά Τύπο Προϋπολογισμού (Τακτικός / ΠΔΕ / Κρατικός)");
        System.out.println(BLUE + "[11] " + RESET + "Προβολή ανά Κατηγορία Πόρων");

        System.out.println(BLUE + "[0] " + RESET + "Επιστροφή στο Κύριο Μενού\n" + RESET_2);
    ...
    public static void printSubMenuOfChoice3() {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Τροποποίηση Ποσού Υφιστάμενου Λογαριασμού Εσόδων");
        System.out.println(BLUE + "[2] " + RESET + "Προσθήκη Γραμμής Εσόδων");
        System.out.println(BLUE + "[3] " + RESET + "Προσθήκη Γραμμής Εξόδων");
        System.out.println(BLUE + "[4] " + RESET + "Διαγραφή Γραμμής");
        System.out.println(BLUE + "[0] " + RESET + "Επιστροφή" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
        int choice = input.nextInt();
        input.nextLine();
    ...
    public static void selectChangeMethodAndApply(BudgetRevenue budgetRevenue) {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Ισόποση μεταβολή υποκατηγοριών");
        System.out.println(BLUE + "[2] " + RESET + "Ποσοστιαία (Αναλογική) μεταβολή υποκατηγοριών");
        System.out.println(BLUE + "[3] " + RESET + "Χειροκίνητη μεταβολή ανά υποκατηγορία" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
    ...
    public static void selectInputMethodAndExecute(BudgetRevenue budgetRevenue, int changeMethod) {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Εισαγωγή Ποσοστού (%) Μεταβολής Λογαριασμού");
        System.out.println(BLUE + "[2] " + RESET + "Εισαγωγή Ποσού (€) Μεταβολής Λογαριασμού");
        System.out.println(BLUE + "[3] " + RESET + "Εισαγωγή Νέου Επιθυμητού Υπολοίπου (€) Λογαριασμού" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
    ...
    public static void printSubMenuOfChoice6() {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Κατανομή Εσόδων (Pie Chart)");
        System.out.println(BLUE + "[2] " + RESET + "Κατανομή Εξόδων (Pie Chart)");
        System.out.println(BLUE + "[3] " + RESET + "Σύγκριση Εσόδων–Εξόδων (Bar Chart)");
        System.out.println(BLUE + "[4] " + RESET + "Δαπάνες ανά Υπουργείο (Bar Chart)");
        System.out.println(BLUE + "[0] " + RESET + "Επιστροφή στο Κύριο Μενού" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
        int choice = input.nextInt();
        input.nextLine();
    ...
    public static void printRevenueChartsSubMenu() {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Κατανομή Βασικών Λογαριασμών Εσόδων");
        System.out.println(BLUE + "[2] " + RESET + "Κατανομή Φόρων");
        System.out.println(BLUE + "[3] " + RESET + "Κατανομή Μεταβιβάσεων");
        System.out.println(BLUE + "[4] " + RESET + "Κατανομή Πωλήσεων Αγαθών & Υπηρεσιών");
        System.out.println(BLUE + "[5] " + RESET + "Κατανομή Λοιπών Τρεχόντων Εσόδων");
        System.out.println(BLUE + "[0] " + RESET + "Επιστροφή στο Κύριο Μενού" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
        int choice = input.nextInt();
    ...
    private static void showTotalRevenuesMenu() {
        ...
        System.out.println("[1] " + RESET + "Κρατικός Προϋπολογισμός");
        System.out.println(BLUE + "[2] " + RESET + "Κρατικός Προϋπολογισμός + Προϋπολογισμός Δημόσιων Επενδύσεων (ΠΔΕ)");
        System.out.println(BLUE + "[3] " + RESET + "Προϋπολογισμός Δημόσιων Επενδύσεων (Εθνικό + Συγχρηματοδοτούμενο Σκέλος)");
        System.out.println(BLUE + "[4] " + RESET + "Εθνικό Σκέλος Προϋπολογισμού Δημόσιων Επενδύσεων");
        System.out.println(BLUE + "[5] " + RESET + "Συγχρηματοδοτούμενο Σκέλος Προϋπολογισμού Δημόσιων Επενδύσεων" + RESET_2);
        System.out.print("\nΕπιλογή: ");
    ...
    public static void printTaxChartsSubMenu() {
        ...
        System.out.println();
        System.out.println("[1] " + RESET + "Κατανομή Βασικών Λογαριασμών Φόρων");
        System.out.println(BLUE + "[2] " + RESET + "Κατανομή Φόρων επί αγαθών και υπηρεσιών");
        System.out.println(BLUE + "[3] " + RESET + "Κατανομή Φόρων Εισοδήματος");
        System.out.println(BLUE + "[0] " + RESET + "Επιστροφή στο Κύριο Μενού" + RESET_2);
        System.out.println();
        System.out.print("Επιλογή: ");
        int choice = input.nextInt();
