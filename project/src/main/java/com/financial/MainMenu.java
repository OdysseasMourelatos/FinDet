...
public class MainMenu {
    public static void printMainMenu() {
        ...
        System.out.println();
        System.out.println(Colors.BLUE + Colors.BOLD + "ΠΡΟΘΥΠΟΥΡΓΟΣ ΓΙΑ ΜΙΑ ΗΜΕΡΑ - BUDGET MANAGER 2026"
        + Colors.RESET + Colors.RESET_2);
        int choice;
        do {
            try {
                System.out.println();
                System.out.println(Colors.BLUE + Colors.BOLD + "=========== ΚΥΡΙΟ ΜΕΝΟΥ ==========="
                + Colors.RESET + Colors.RESET_2);
                System.out.println();
                ...
                System.out.println(Colors.BLUE + Colors.BOLD + "[4] " + Colors.RESET
                + "Αναζήτηση Στοιχείων Προϋπολογισμού" + Colors.RESET_2);
                ...
                if (choice == 1) {
                    ...
                    + "Αναζήτηση με Περιγραφή / Λέξη-κλειδί" + Colors.RESET_2);
                    ...
                    System.out.println(Colors.BLUE + Colors.BOLD + "[3] " + Colors.RESET
                    + "Μεταβολές σε σχέση με προηγούμενο έτος" + Colors.RESET_2);
                    ...
                    System.out.println(Colors.BLUE + Colors.BOLD + "[2] " + Colors.RESET + "Εξαγωγή Εξόδων σε PDF" + RESET_2);
                    System.out.println(Colors.BLUE + Colors.BOLD + "[3] " + Colors.RESET
                    + "Εξαγωγή Τελικού Κρατικού Προϋπολογισμού σε PDF" + Colors.RESET_2);
                    System.out.println(Colors.BLUE + Colors.BOLD + "[4] " + Colors.RESET
                    + "Εξαγωγή Προϋπολογισμού Δημόσιων Επενδύσεων σε PDF" + Colors.RESET_2);
