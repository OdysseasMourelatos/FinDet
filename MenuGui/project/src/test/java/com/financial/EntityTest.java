...
public class EntityTest {
    @BeforeEach
    public void resetEntitiesList() throws Exception {
        Field field = Entity.class.getDeclaredField("entities");
        field.setAccessible(true);
        field.set(null, new ArrayList<Entity>());
    }
    @Test
    public void testConstructorAddsEntityToList() throws Exception {
    ...
    @Test
    public void testFindEntityWithEntityCode_Found() {
    ...
    @Test
    public void testFindEntityWithEntityCode_NotFound() {
