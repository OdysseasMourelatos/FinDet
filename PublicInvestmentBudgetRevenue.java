...
public class PublicInvestmentBudgetRevenue extends BudgetRevenue implements IBudgetRevenueLogic  {
    ...
    public PublicInvestmentBudgetRevenue findSuperCategory() {
     ...
     @Override
    public ArrayList<PublicInvestmentBudgetRevenue> getSuperCategories() {
    ...
    public void printSuperCategoriesTopDown() {
        ArrayList<PublicInvestmentBudgetRevenue> superCategories = new ArrayList<>();
    ...
    @Override
    public ArrayList<PublicInvestmentBudgetRevenue> findAllSubCategories() {
    ...
    @Override
    public ArrayList<PublicInvestmentBudgetRevenue> findNextLevelSubCategories() {
